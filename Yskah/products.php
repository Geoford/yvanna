...
<div class="navi-bar">
    <div class="navi-items">
        ...
        <div class="navi-btn">
            <div class="buttons "><i class='bx bx-home-alt'></i><a href="landing_page.php">Home</a></div>
            <div class="buttons active"><i class='bx bx-shopping-bag' ></i><a href="products.php">Products</a></div>
